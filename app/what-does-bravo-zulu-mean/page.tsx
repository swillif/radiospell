...
export default function BravoZuluPage() {
  const terms = [
    ...
    { term: 'Foxtrot Oscar', abbr: 'FO', meaning: 'A blunt way to tell someone to leave', origin: 'A NATO-alphabet way to express strong displeasure without technically using profanity. Common in informal military communication but not appropriate in formal contexts.', example: 'Used informally among troops — self-explanatory.' },
    { term: 'Whiskey Tango Foxtrot', abbr: 'WTF', meaning: 'Expression of shock or disbelief', origin: 'The NATO alphabet spelling of a well-known acronym expressing surprise or disbelief. Entered mainstream culture through military usage and is now widely understood in civilian contexts as well.', example: '"Did you just see that? Whiskey Tango Foxtrot."' },
